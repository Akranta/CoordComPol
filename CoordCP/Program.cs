...
namespace coord
{
    public class Complex
    {
        ...
        {
            return Math.Round(obj1.Img, 3) == Math.Round(obj2.Img, 3) && Math.Round(obj1.Real, 3) == Math.Round(obj2.Real, 3);
        }
    ...
    public class PolarCoord
    {
        ...
        {
            Complex answ = new Complex();
            answ.Real = this.rad * Math.Cos(this.angle);
            answ.Img = this.rad * Math.Sin(this.angle);
            return answ;
        }
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            PolarCoord account_a = new PolarCoord(3.16228, 1.24905);
            Complex account_c = account_a.ToComplex();
            Complex answer = new Complex(1, 3);
            Console.WriteLine(Math.Round(account_c.Img, 4));
            Console.WriteLine(Math.Round(answer.Img, 4));
